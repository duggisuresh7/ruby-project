...
class PlayersTest < ApplicationSystemTestCase
  ...
  test "should create player" do
    ...
    fill_in "Battingstyle", with: @player.battingstyle
    fill_in "Birthplace", with: @player.birthplace
    fill_in "Born", with: @player.born
    fill_in "Bowling", with: @player.bowling
    fill_in "Nickname", with: @player.nickname
    fill_in "Playername", with: @player.playername
    fill_in "Role", with: @player.role
    fill_in "Style", with: @player.style
